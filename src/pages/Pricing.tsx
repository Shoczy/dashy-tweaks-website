            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                ...
                <div className="glass-card rounded-3xl p-8">
                    ...
                    <ul className="space-y-4 mb-8">
                        <PricingFeature>50+ Basic tweaks</PricingFeature>
                        <PricingFeature>FPS optimizations</PricingFeature>
                ...
                <div className="relative glass-card rounded-3xl p-8 border-emerald-500/30 glow-green">
                    ...
                    <div className="mb-8">
                        ...
                        <span className="text-neutral-500 ml-2">lifetime</span>
                    </div>
                    ...
                    <ul className="space-y-4 mb-8">
                        ...
                        <PricingFeature premium>Security optimizations</PricingFeature>
                    ...
                    <p className="text-center text-xs text-neutral-500 mt-4">
                        Purchase via Discord • Instant key delivery
                    </p>
                </div>
            </div>
