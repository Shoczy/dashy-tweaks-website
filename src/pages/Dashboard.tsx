                    ...
                    <div className="p-8 max-w-3xl mx-auto">
                        ...
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500/10 to-transparent border border-emerald-500/20 p-8 mb-6">
                            ...
                            <div className="relative flex items-center gap-6 mb-6">
                                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-500/30"><svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg></div>
                                <div>
                                    <h2 className="text-2xl font-bold text-white mb-1">Dashy Tweaks</h2>
                                    <p className="text-neutral-400 mb-2">v1.3.0 • Windows 10/11</p>
                                    <div className="flex items-center gap-3">
                                        <span className="px-2 py-1 bg-emerald-500/20 text-emerald-400 text-xs font-medium rounded">Latest</span>
                                        <span className="text-xs text-neutral-500">~45 MB</span>
                                    </div>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <a href="https://github.com/Shoczy/dashy-tweaks-tauri/releases/latest/download/Dashy.Tweaks_1.3.0_x64-setup.exe" className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-500 hover:bg-emerald-400 rounded-xl font-semibold text-white shadow-lg shadow-emerald-500/30 transition-all">
                                ...
                                <a href="https://github.com/Shoczy/dashy-tweaks-tauri/releases/latest" target="_blank" className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 hover:bg-white/10 rounded-xl font-medium text-white transition-all">
                        ...
                        {/* System Requirements */}
                        <div className="rounded-2xl bg-white/5 border border-white/5 p-6 mb-6">
                            <h3 className="font-semibold text-white mb-4 flex items-center gap-2">
                                <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" /></svg>
                                System Requirements
                            </h3>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 rounded-xl bg-black/20">
                                    <p className="text-xs text-neutral-500 mb-1">Operating System</p>
                                    <p className="text-white font-medium">Windows 10/11 (64-bit)</p>
                                </div>
                                <div className="p-4 rounded-xl bg-black/20">
                                    <p className="text-xs text-neutral-500 mb-1">Processor</p>
                                    <p className="text-white font-medium">Any modern CPU</p>
                                </div>
                                <div className="p-4 rounded-xl bg-black/20">
                                    <p className="text-xs text-neutral-500 mb-1">Memory</p>
                                    <p className="text-white font-medium">4 GB RAM minimum</p>
                                </div>
                                <div className="p-4 rounded-xl bg-black/20">
                                    <p className="text-xs text-neutral-500 mb-1">Storage</p>
                                    <p className="text-white font-medium">100 MB available</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl bg-white/5 border border-white/5 p-6">
                            ...
                            <div className="space-y-3">
                                {[
                                    { title: '270+ Optimization Tweaks', desc: 'FPS boost, input delay reduction, network optimization' },
                                    { title: '24 Game Templates', desc: 'Pre-configured settings for popular games' },
                                    { title: 'One-Click Apply', desc: 'Apply all tweaks with a single click' },
                                    { title: 'Auto Updates', desc: 'Always stay on the latest version' },
                                ].map((item, i) => (
                                    <div key={i} className="flex items-start gap-3 p-3 rounded-xl bg-black/20">
                                        <div className="w-5 h-5 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                                            <svg className="w-3 h-3 text-emerald-400" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                                        </div>
                                        <div>
