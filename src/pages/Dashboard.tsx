                    ...
                    <div className="p-8 max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-6">
                            ...
                            <div className="grid grid-rows-2 gap-4">
                                ...
                                <div className="p-4 rounded-xl bg-white/5 border border-white/5 flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-lg bg-emerald-500/10 flex items-center justify-center"><svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" /><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div>
                                    <div><p className="text-lg font-bold text-white">24</p><p className="text-xs text-neutral-500">Game Templates</p></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="rounded-2xl bg-white/5 border border-white/5 p-5">
                                ...
                                <div className="space-y-2">
                                    {['FPS Boost & Input Delay Reduction', 'Network & GPU Optimization', 'One-Click Apply All', 'Auto Updates'].map((item, i) => (
                            ...
                            <div className="rounded-2xl bg-white/5 border border-white/5 p-5">
                                <h3 className="font-semibold text-white mb-3 text-sm">Requirements</h3>
                                <div className="grid grid-cols-2 gap-3">
                                    <div><p className="text-xs text-neutral-500">OS</p><p className="text-sm text-white">Windows 10/11</p></div>
                                    <div><p className="text-xs text-neutral-500">CPU</p><p className="text-sm text-white">Any modern</p></div>
                                    <div><p className="text-xs text-neutral-500">RAM</p><p className="text-sm text-white">4 GB+</p></div>
                                    <div><p className="text-xs text-neutral-500">Storage</p><p className="text-sm text-white">100 MB</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
